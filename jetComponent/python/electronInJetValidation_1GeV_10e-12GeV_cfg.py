...
process = cms.Process("electronInJetValidation")
...
electronInJetValidationParams = cms.PSet(
    ### parameter set

    # The mass window would be [ (1-ZpMassSideBand)*M, (1+ZpMassSideBand)*M ]
    ZpMassSideBand = cms.untracked.double(1), 
    ZpMass         = cms.untracked.double(1),
    dRusb          = cms.untracked.double(0.4)
)

process.electronInJetValidation = cms.EDAnalyzer('sidm::electronInJetValidation',
                                      electronInJetValidationParams,
...
process.TFileService = cms.Service("TFileService",
                                   fileName
                                   = cms.string("$CMSSW_BASE/src/sidm-bs/jetComponent/mydata/electronInJetValidation_1GeV_10e-12GeV.root"))
