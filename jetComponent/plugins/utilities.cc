 ...
 *
 * @param [const std::pair<edm::Ptr<pat::Electron>, edm::Ptr<pat::Electron> >&] under_test pair of electrons to be tested
 * @param [std::vector<sidm::Zp>&] zps vector(2) gen zps tested against
 * @param [double] deltaR_upsideband limit of deltaR
 */
void
sidm::match_patPair_with_zps (const std::pair<edm::Ptr<pat::Electron>, edm::Ptr<pat::Electron> >& under_test,
