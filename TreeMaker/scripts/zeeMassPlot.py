...
genZ1PtHist.SetFillColorAlpha(ROOT.kAzure+3, 1.)
genZ2PtHist.SetFillColorAlpha(ROOT.kOrange+7, 1.)
genZ2PtHist.Draw()
...
genM1eeHist.SetFillColorAlpha(ROOT.kAzure+3, 1.)
genM2eeHist.SetFillColorAlpha(ROOT.kOrange+7, 1.)
genM1eeHist.Draw()
...
genE1PtHist.SetFillColorAlpha(ROOT.kAzure+3, 1.)
genE2PtHist.SetFillColorAlpha(ROOT.kOrange+7, 1.)
genE3PtHist.SetFillColorAlpha(ROOT.kPink-2, 1.)
genE4PtHist.SetFillColorAlpha(ROOT.kGreen+3, 1.)
genE2PtHist.Draw()
...
patZ1PtHist.SetFillColorAlpha(ROOT.kAzure+3, 1.)
patZ2PtHist.SetFillColorAlpha(ROOT.kOrange+7, 1.)
patZ2PtHist.Draw()
...
patM1eeHist.SetFillColorAlpha(ROOT.kAzure+3, 1.)
patM2eeHist.SetFillColorAlpha(ROOT.kOrange+7, 1.)
patM2eeHist.SetMaximum(32)
patM2eeHist.Draw()
...
patE1PtHist.SetFillColorAlpha(ROOT.kAzure+3, 1.)
patE2PtHist.SetFillColorAlpha(ROOT.kOrange+7, 1.)
patE3PtHist.SetFillColorAlpha(ROOT.kPink-2, 1.)
patE4PtHist.SetFillColorAlpha(ROOT.kGreen+3, 1.)
patE4PtHist.Draw()
